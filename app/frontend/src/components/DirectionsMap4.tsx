...
import { getCourierActiveOrder, getOrder, getCourierLocation} from '../middleware';
...
function Directions({ errorHandler, loadHandler, orderId }: DirectionProps) {
...
export default function DirectionsMap4({ orderId }) { 
      ...
      <div style={{ width: "100%", height: "100vh" }}>
        <APIProvider apiKey={apiKey} onLoad={() => console.log('Maps API has loaded.')}>
          <div className='map-container'>
            <Directions loadHandler={loadHandler} errorHandler={errorHandler} orderId={orderId} />
            <Map
              id={'map'}
              defaultZoom={13}
