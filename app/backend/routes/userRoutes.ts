...
import { getUserActiveOrders, getUserActiveOrder, getUserCurrentLocation, getCustomerConfirmationPin, updateNotification, updateRole, getNotificationSettings, getRoleSettings } from '../controllers/userController';
...
router.get('/:userId/orders2', getUserActiveOrders);
